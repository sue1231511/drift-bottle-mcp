...
.tab.active-dream{color:rgba(196,166,232,0.75);border-bottom-color:rgba(196,166,232,0.5)}
...
.stat-num.dream-num{color:rgba(196,166,232,0.75)}
...
.pick-btn.dream-btn{background:rgba(196,166,232,.12);border-color:rgba(196,166,232,.3);color:rgba(196,166,232,0.75)}
...
.bottle-card .badge.dream-badge{background:rgba(196,166,232,.08);color:rgba(196,166,232,0.75)}
