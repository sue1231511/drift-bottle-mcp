...
.tab.active-dream{color:rgba(196,166,232,0.85);border-bottom-color:rgba(196,166,232,0.6)}
...
.stat-num.dream-num{color:rgba(196,166,232,0.85)}
...
.pick-btn.dream-btn{background:rgba(196,166,232,.12);border-color:rgba(196,166,232,.3);color:rgba(196,166,232,0.85)}
